...
int main(void)
{
  ...
  MX_SPI1_Init();
  /* USER CODE BEGIN 2 */
  // Turn ON the LED on PD6
  HAL_GPIO_WritePin(SCREEN_LED_GPIO_Port, SCREEN_LED_Pin, GPIO_PIN_SET); 
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, SCREEN_CS_Pin|SCREEN_LED_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, SCREEN_RST_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SCREEN_CS_Pin SCREEN_RST_Pin SCREEN_LED_Pin */
  GPIO_InitStruct.Pin = SCREEN_CS_Pin|SCREEN_RST_Pin|SCREEN_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
